...
void BERENDSEN_THERMOSTAT_INFORMATION::Initial(CONTROLLER *controller, float target_temperature, const char *module_name)
{
    ...
    {
        controller->Check_Float(this->module_name, "tau", "BERENDSEN_THERMOSTAT_INFORMATION::Initial");
    ...
    {
        controller->Check_Int(this->module_name, "stochastic_term", "BERENDSEN_THERMOSTAT_INFORMATION::Initial");
        stochastic_term = atoi(controller[0].Command(this->module_name, "stochastic_term"));
    }
    ...
    if (stochastic_term)
    {
        ...
        {
            controller->Check_Int(this->module_name, "seed", "BERENDSEN_THERMOSTAT_INFORMATION::Initial");
