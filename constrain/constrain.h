...
struct CONSTRAIN
{
    ...
    void Initial_List(CONTROLLER* controller, CONECT connectivity, PAIR_DISTANCE con_dis, float* atom_mass, const char* module_name = NULL);
...
#endif //SIMPLE_CONSTARIN_CUH(simple_constrain.h)
